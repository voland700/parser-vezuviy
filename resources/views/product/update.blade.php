...
@section('title', 'Обновление данных - товара Везувий')
            ...
            <form action="{{route('product.update', $product->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        <input type="text" class="form-control @error('number') is-invalid @enderror" id="number"  name="number" value="{{$product->number}}">
                    </div>

                    <div class="form-group col-lg-6">
                        <label for="code">Штрих-код товара</label>
                        <input type="number" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{$product->code}}">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="link" name="link" value="{{ $product->link }}">
                </div>
